...
### paired t-tests
```{r tazootstats, echo = FALSE, out.width = "90%"}
## valid vs. invalid
d <- data 
...
my_table <- nice_table(stats.table, report = "t.test", title = "tazoot: valid vs invalid")
my_table
```
...
my_table <- nice_table(stats.table, report = "t.test", title = "tazoot: valid vs neutral")
my_table
```
...
my_table <- nice_table(stats.table, report = "t.test", title = "tazoot: invalid vs neutral")
my_table
```
