...
for iContrast = 1:numel(contrastConds)
    ...
    hold on
    if iContrast==1
        kt_annotateStats(1,14.25,'*');
        kt_drawBracket(.7778, 1.2222, .96)
        % kt_annotateStats(2,94,'~');
        % kt_drawBracket(1.7778, 2.2222, .9)

        kt_annotateStats(1,16.5,'_______');
        kt_annotateStats(1,16.75,'* Validity');

        kt_annotateStats(1.5,18,'___________________');
        kt_annotateStats(1.5,18.25,'*** Target');
        kt_annotateStats(1.5,19.25,'* Validity');
    ...
    elseif iContrast == 3
        ...
        kt_annotateStats(1,17.5,'_______');
        kt_annotateStats(1,17.75,'** Validity');

        kt_annotateStats(1.5,19,'___________________');
        kt_annotateStats(1.5,20.5,'** Target');
        kt_annotateStats(1.5,21.5,'*** Validity');
        kt_annotateStats(1.5,19.25,'** Target:Validity');



    elseif iContrast == 2
        kt_annotateStats(1,14.25,'**');
        kt_drawBracket(.7778, 1.2222, .72)

        kt_annotateStats(1,17,'_______');
        kt_annotateStats(1,17.25,'* Validity');
    end
