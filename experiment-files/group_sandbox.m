...
for iSub=1:length(subs) % for participant
   ...
   %% variables
    ...
    nfDet = dataAll(iSub).seen == 1 & dataAll(iSub).targetContrast == 0; % fa: seen and absent
    ...
    for iTarget = 1:2
        for iValid = 1:numel(Validities)
            for iF = 1:numel(Detfieldnames)
                dataAll(iSub).nh.(Detfieldnames{iF})(iTarget,iValid) = det.(Detfieldnames{iF})(iTarget,iValid,1);
                dataAll(iSub).nfa.(Detfieldnames{iF})(iTarget,iValid) = det.(Detfieldnames{iF})(iTarget,iValid,2);
                dataAll(iSub).nsignal.(Detfieldnames{iF})(iTarget,iValid) = det.(Detfieldnames{iF})(iTarget,iValid,3);
                dataAll(iSub).nnoise.(Detfieldnames{iF})(iTarget,iValid) = det.(Detfieldnames{iF})(iTarget,iValid,4);
                [dprime, criterion] = kt_dprime2(dataAll(iSub).nh.(Detfieldnames{iF})(iTarget,iValid), dataAll(iSub).nfa.(Detfieldnames{iF})(iTarget,iValid), dataAll(iSub).nsignal.(Detfieldnames{iF})(iTarget,iValid), dataAll(iSub).nnoise.(Detfieldnames{iF})(iTarget,iValid),1);
    ...
    nfDis = dataAll(iSub).correctDis == 0 & dataAll(iSub).targetTilt == 1;
    ...
    for iTarget = 1:2
        for iValid = 1:numel(Validities)
            for iF = 1:numel(Disfieldnames)
                dataAll(iSub).nh.(Disfieldnames{iF})(iTarget,iValid) = dis.(Disfieldnames{iF})(iTarget,iValid,1);
                dataAll(iSub).nfa.(Disfieldnames{iF})(iTarget,iValid) = dis.(Disfieldnames{iF})(iTarget,iValid,2);
                dataAll(iSub).nsignal.(Disfieldnames{iF})(iTarget,iValid) = dis.(Disfieldnames{iF})(iTarget,iValid,3);
                dataAll(iSub).nnoise.(Disfieldnames{iF})(iTarget,iValid) = dis.(Disfieldnames{iF})(iTarget,iValid,4);
                [dprime, criterion] = kt_dprime2(dataAll(iSub).nh.(Disfieldnames{iF})(iTarget,iValid), dataAll(iSub).nfa.(Disfieldnames{iF})(iTarget,iValid), dataAll(iSub).nsignal.(Disfieldnames{iF})(iTarget,iValid), dataAll(iSub).nnoise.(Disfieldnames{iF})(iTarget,iValid),1);
