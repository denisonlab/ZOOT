    ...
    for iTarget = 1:2
        for iValid = 1:3
            ...
            swarmchart( xVals(iTarget,iValid), squeeze(tcAcc_scatterplot.(targ_contrasts{iContrast})(iValid,:,iTarget)),'filled',...
                'SizeData',fp.scatter.size,'XJitterWidth',100,'MarkerFaceColor',fp.colorsTargets(iTarget,iValid,:),'MarkerEdgeColor',fp.scatter.edgeColor,'MarkerFaceAlpha',fp.scatter.alpha ); 
