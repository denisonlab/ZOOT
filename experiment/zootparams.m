...
switch s.comp
    ...
    case 'denlab-beh'
        ...
        p.viewDist = 75;
        p.refreshRate = 120;
        p.dir = '/home/denisonlab-beh/Experiments/ZOOT/experiment';
        p.retina = 0;
        p.useKbQueue = 1;
        if s.exptStage > 0
            p.eyeTracking = 1; 
    ...
    case 'denlab-eeg'
        ...
        p.viewDist = 57;
        p.refreshRate = 120;
        p.dir = '/home/denisonlab/Experiments/ZOOT/experiment';
        p.retina = 1;
        p.useKbQueue = 1;
        p.eyeTracking = 1;
        p.windowTesting = 0;
...
%% Images
p.backgroundColor = 0.5; % gray, 0.5
p.imPos = [0 0];
