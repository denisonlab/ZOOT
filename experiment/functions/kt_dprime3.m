function [dprime, criterion] = kt_dprime3(nh,nfa,nsignal,nnoise,loglinear)
...
% jm made this on 4/18/2025 to test difference between using loglinear
% correction on all trials vs. only extremem HR and FAR trials
