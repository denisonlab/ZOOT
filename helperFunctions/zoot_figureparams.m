...
%% Sizing
fp.rect = [100 100 500 400]; % dimensions for bar plots
fp.rectLine = [100 100 400 400]; % dimensions for line plots
...
fp.xVals = [0.7778 1 1.222;... % T1 (
    1.7778 2 2.2222]; % T2
fp.xVals(2,:) = fp.xVals(2,:)-0.15; % 0.2
...
fp.coolColors(1,:) = [93 192 229]/255; % blue 
fp.coolColors(2,:) = [227 122 57]/255; % orange
fp.coolColors(3,:) = [104 183 121]/255; % green
